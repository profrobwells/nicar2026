...
[Link to Github repo - select NICAR_Text_analysis_2026]{style="font-size: 18pt;"}

![](wells_nicar_2026.png){width="50%"}
:::
...
#You can adjust the number of words on either side with the window variable
